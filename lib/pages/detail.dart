                                ...
                                child: Column(
                                    ...
                                    children: <Widget>[
                                      Container(
                                        ...
                                        child: FittedBox(
                                          child: Text('Masukan / Pilih Nominal',
                                          style: TextStyle(
                                              fontFamily: 'Montserrat',
                                              fontSize: 13,
                                              color: Color(0xFF999494),
                        ...
                        children: <Widget>[
                          GestureDetector(
                              ...
                              onTap: () {
                                ...
                                var sementara = (int.parse(jumlahController.text.replaceAll('.', '')) + 10000).toString();
                                ...
                                setState(() {
                                  jumlahController.text = fo.withoutFractionDigits.toString();
                                });
                              }),
                          GestureDetector(
                              child: Column(children: <Widget>[
                              ...
                              onTap: () {
                                ...
                                var sementara = (int.parse(jumlahController.text.replaceAll('.', '')) + 30000).toString();
                                MoneyFormatterOutput fo = FlutterMoneyFormatter(
                                  amount: double.parse(sementara),
                                  settings:MoneyFormatterSettings(
                                    thousandSeparator: '.',
                          ...
                          GestureDetector(
                              ...
                              onTap: () {
                                ...
                                var sementara = (int.parse(jumlahController.text.replaceAll('.', '')) + 50000).toString();
                                MoneyFormatterOutput fo = FlutterMoneyFormatter(
                                  amount: double.parse(sementara),
                                  settings:MoneyFormatterSettings(
                                    thousandSeparator: '.',
                          ...
                          GestureDetector(
                              ...
                              onTap: () {
                                ...
                                var sementara = (int.parse(jumlahController.text.replaceAll('.', '')) + 100000).toString();
                                MoneyFormatterOutput fo = FlutterMoneyFormatter(
                                  amount: double.parse(sementara),
                                  settings:MoneyFormatterSettings(
                                    thousandSeparator: '.',
                        ...
                        child: Column(children: <Widget>[
                            ...
                            GestureDetector(
                                ...
                                onTap: () {
                                  if (jumlahController.text.length >= 13) {
                                      ...
                                      var sementara = jumlahController.text.replaceAll('.', '') + '1';
                                      MoneyFormatterOutput fo = FlutterMoneyFormatter(
                                        amount: double.parse(sementara),
                                        settings:MoneyFormatterSettings(
                                          thousandSeparator: '.',
                            ...
                            GestureDetector(
                                ...
                                onTap: () {
                                  if (jumlahController.text.length >= 13) {
                                      ...
                                      var sementara = jumlahController.text.replaceAll('.', '') + '2';
                                      MoneyFormatterOutput fo = FlutterMoneyFormatter(
                                        amount: double.parse(sementara),
                                        settings:MoneyFormatterSettings(
                                          thousandSeparator: '.',
                            ...
                            GestureDetector(
                                ...
                                onTap: () {
                                  if (jumlahController.text.length >= 13) {
                                      ...
                                      var sementara = jumlahController.text.replaceAll('.', '') + '3';
                                      MoneyFormatterOutput fo = FlutterMoneyFormatter(
                                        amount: double.parse(sementara),
                                        settings:MoneyFormatterSettings(
                                          thousandSeparator: '.',
                            ...
                            GestureDetector(
                                ...
                                onTap: () {
                                  if (jumlahController.text.length >= 13) {
                                      ...
                                      var sementara = jumlahController.text.replaceAll('.', '') + '4';
                                      MoneyFormatterOutput fo = FlutterMoneyFormatter(
                                        amount: double.parse(sementara),
                                        settings:MoneyFormatterSettings(
                                          thousandSeparator: '.',
                            ...
                            GestureDetector(
                                ...
                                onTap: () {
                                  if (jumlahController.text.length >= 13) {
                                      ...
                                      var sementara = jumlahController.text.replaceAll('.', '') + '5';
                                      MoneyFormatterOutput fo = FlutterMoneyFormatter(
                                        amount: double.parse(sementara),
                                        settings:MoneyFormatterSettings(
                                          thousandSeparator: '.',
                            ...
                            GestureDetector(
                                ...
                                onTap: () {
                                  if (jumlahController.text.length >= 13) {
                                      ...
                                      var sementara = jumlahController.text.replaceAll('.', '') + '6';
                                      MoneyFormatterOutput fo = FlutterMoneyFormatter(
                                        amount: double.parse(sementara),
                                        settings:MoneyFormatterSettings(
                                          thousandSeparator: '.',
                            ...
                            GestureDetector(
                                ...
                                onTap: () {
                                  if (jumlahController.text.length >= 13) {
                                      ...
                                      var sementara = jumlahController.text.replaceAll('.', '') + '7';
                                      MoneyFormatterOutput fo = FlutterMoneyFormatter(
                                        amount: double.parse(sementara),
                                        settings:MoneyFormatterSettings(
                                          thousandSeparator: '.',
                            ...
                            GestureDetector(
                                ...
                                onTap: () {
                                  if (jumlahController.text.length >= 13) {
                                      ...
                                      var sementara = jumlahController.text.replaceAll('.', '') + '8';
                                      MoneyFormatterOutput fo = FlutterMoneyFormatter(
                                        amount: double.parse(sementara),
                                        settings:MoneyFormatterSettings(
                                          thousandSeparator: '.',
                            ...
                            GestureDetector(
                                ...
                                onTap: () {
                                  if (jumlahController.text.length >= 13) {
                                      ...
                                      var sementara = jumlahController.text.replaceAll('.', '') + '9';
                                      MoneyFormatterOutput fo = FlutterMoneyFormatter(
                                        amount: double.parse(sementara),
                                        settings:MoneyFormatterSettings(
                                          thousandSeparator: '.',
                          ...
                          Row(children: <Widget>[
                            GestureDetector(
                                ...
                                onTap: () {
                                  if (jumlahController.text.length >= 13) {
                                      ...
                                      var sementara = jumlahController.text.replaceAll('.', '') + '0';
                                      MoneyFormatterOutput fo = FlutterMoneyFormatter(
                                        amount: double.parse(sementara),
                                        settings:MoneyFormatterSettings(
                                          thousandSeparator: '.',
                            ...
                            GestureDetector(
                                ...
                                onTap: () {
                                  if (jumlahController.text.length >= 10) {
                                      ...
                                      var sementara = jumlahController.text.replaceAll('.', '') + '000';
                                      MoneyFormatterOutput fo = FlutterMoneyFormatter(
                                        amount: double.parse(sementara),
                                        settings:MoneyFormatterSettings(
                                          thousandSeparator: '.',
                            ...
                            GestureDetector(
                                ...
                                onTap: () {
                                  var replace = jumlahController.text.replaceAll('.', '');
                                  var sementara = replace.substring(0, replace.length - 1);
                                  ...
                                  ? widget.role == 'user'
                                      ...
                                      : Visibility(
                                          visible: ((int.parse(jumlahController.text.replaceAll('.', '')) + 1) != 1)
                                              ...
                                              : false,
                                          child: Row(
                                            mainAxisAlignment: widget.tp == 'fixed'
                                            ? MainAxisAlignment.center
                                            ...
                                            Container(
                                                ...
                                                child: RaisedButton(
                                                  ...
                                                  onPressed: () {
                                                    if (int.parse(jumlahController.text.replaceAll('.', '')) <= 100000) {
                                                      MoneyFormatterOutput fo = FlutterMoneyFormatter(
                                                              amount: double.parse(jumlahController.text.replaceAll('.', '')),
                                                              settings:MoneyFormatterSettings(
                                                                thousandSeparator: '.',
                                                                decimalSeparator:',',
                                                              )).output;
                                                                            ...
                                                                            child: FittedBox(
                                                                              ...
                                                                              text: new TextSpan(
                                                                                ...
                                                                                children: <TextSpan>[
                                                                                  ...
                                                                                  new TextSpan(
                                                                                      text:
                                                                                          'Sebesar Rp ${fo.withoutFractionDigits} kepada $namaTujuan'),
                                                                                ],
                                                                              ),
                                                                            ))),
                                                                              Row(
                                                                            ...
                                                                            child: FittedBox(
                                                                              ...
                                                                              text: new TextSpan(
                                                                                ...
                                                                                children: <TextSpan>[
                                                                                  new TextSpan(
                                                                                      text:
                                                                                          'Minimal satu kali Top Up adalah \n'),
                                                                                  new TextSpan(
                                                                                      text:
                                                                                          'Sebesar Rp 100.000'),
                                                                                ],
