    ...
    return WillPopScope(
        onWillPop: () {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => new NoTelp()));
          },
        child: Scaffold(
            appBar: AppBar(
                ...
                Expanded(
                  ...
                  Container(
                    ...
                    text: new TextSpan(
                      ...
                      children: <TextSpan>[
                        new TextSpan(
                            text: 'Tenang apabila anda merasa tidak ada\n'),
                        new TextSpan(
                            text: 'yang salah, silahkan hubungi admin kami'),
                      ],
                    ),
                  ))))
                ]))),
                ...
                color: Color(0xFFF4F7F8),
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border(
                              right: BorderSide(
                                  color: Color(0xFFC7C6C6), width: 1.0)))),
                  Expanded(
                      child: GestureDetector(
                        onTap: () {
                          launch("mailto:info@bill.co.id?subject=Suspend");
                          },
                        child: Container(
                        color: Color(0xFFF4F7F8),
                          alignment: Alignment.center,
