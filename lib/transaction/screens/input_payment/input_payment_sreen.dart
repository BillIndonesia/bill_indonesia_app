...
class _InputPaymentScreenState extends State<InputPaymentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String merchantType = data['merchant_type']['merchant_type_name'];
    Uint8List bytes;
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    //nominal button
                    merchantType == 'warung'
                        ? warungButton(context)
                        : angkotButton(context),
                    // procces button
                    isNominalFilled()
                        ? Visibility(
  ...
  bool isNominalFilled() {
    return jumlahController.text != '' &&
        (int.parse(jumlahController.text.replaceAll('.', '')) + 1) != 1;
  }

  Row angkotButton(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceAround,
      children: <Widget>[
  ...
  Container warungButton(BuildContext context) {
    return Container(
        ...
        children: [
          ...
          Container(
            ...
            child: NumericKeyboard(
              onKeyboardTap: (value) {
                var sementara =
                    jumlahController.text.replaceAll('.', '') + value;
                MoneyFormatterOutput fo = MoneyFormatter(
                    amount: double.parse(sementara),
                    settings: MoneyFormatterSettings(
                      thousandSeparator: '.',
              ...
              textColor: Color(0xFFF4F7F8),
              rightButtonFn: () {
                setState(
                  () {
                    jumlahController.text = jumlahController.text
                        .substring(0, jumlahController.text.length - 1);
                  },
                );
              },
              rightIcon: Icon(
